...
ASGI_APPLICATION = 'drf_boilerplate.asgi.application'
...
INTELLA_API_TOKEN_ID = os.getenv('INTELLA_API_TOKEN_ID')
INTELLA_API_ACCOUNT_ID = os.getenv('INTELLA_API_ACCOUNT_ID')

OPENAI_API_KEY = os.environ["OPENAI_API_KEY"]

REDIS_HOST = os.environ["REDIS_HOST"]
REDIS_PORT_INT = os.environ["REDIS_PORT_INT"]